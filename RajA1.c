...
int Forge(pairing_t pairing, Vehicle vehicles[40],    element_t S,     const char **m,         element_t P,    element_t Y){
    ...
    element_random(vehicles[0].Xi);// 🔥 V_0's public key is randomly generated by the adversary.
...
{   Vehicle V[40];
    ...
    int result=aggregate_verify(pairing, V, S, msgs, P, Y);//S is the forged aggregate signature.
    if(result)
