          ...
          pairing_t pairing)
{
    ...
    element_mul(temp_z2, h3,temp_zr);     
    element_add(si, temp_z2, xi);
           ...
           const char *t)
{
    ...
    H3(beta_i, PID1i, PID2i, t_i, m_i, t); 
    element_mul_zn(right_term1, t_i, beta_i);
    element_mul_zn(right_term2, Y, alpha_i);  
    element_add(right_term2, right_term1, right_term2); 
    element_add(right_term2, PID1i, right_term2); 
    element_add(right_term2, right_term2, Xi);
